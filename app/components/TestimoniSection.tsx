    ...
    <section className="py-16 px-3 md:px-10 mt-20">
      ...
      <div className="overflow-hidden pb-5 relative w-full mt-10">
        ...
        <div className="flex animate-slide gap-5">
          ...
          {waliMurid.map((wali, idx) => (
            <div key={`dup-${idx}`} className="flex bg-white shadow-md rounded-[100px_20px_20px_100px] p-4 md:p-[18px] h-auto md:h-[135px] w-full md:w-[650px] shrink-0">
              <div className="h-[80px] w-[80px] md:h-[100px] md:w-[100px] flex-shrink-0">
                <Image src={wali.foto} width={100} height={100} alt={wali.nama} className="h-[80px] w-[80px] md:h-[100px] md:w-[100px] rounded-full object-cover bg-gray-300" />
              </div>
              <div className="pl-4 md:pl-8 flex flex-col justify-center">
        ...
        <div className="flex animate-slide-reverse gap-5 mt-5">
          {waliMurid
            ...
            .reverse()
            .map((wali, idx) => (
              <div key={`rev-${idx}`} className="flex bg-white shadow-md rounded-[100px_20px_20px_100px] p-4 md:p-[18px] h-auto md:h-[135px] w-full md:w-[650px] shrink-0">
                <div className="h-[80px] w-[80px] md:h-[100px] md:w-[100px] flex-shrink-0">
                  <Image src={wali.foto} width={100} height={100} alt={wali.nama} className="h-[80px] w-[80px] md:h-[100px] md:w-[100px] rounded-full object-cover bg-gray-300" />
                </div>
                <div className="pl-4 md:pl-8 flex flex-col justify-center">
          ...
          {waliMurid
            ...
            .reverse()
            .map((wali, idx) => (
              <div key={`revdup-${idx}`} className="flex bg-white shadow-md rounded-[100px_20px_20px_100px] p-4 md:p-[18px] h-auto md:h-[135px] w-full md:w-[650px] shrink-0">
                <div className="h-[80px] w-[80px] md:h-[100px] md:w-[100px] flex-shrink-0">
                  <Image src={wali.foto} width={100} height={100} alt={wali.nama} className="h-[80px] w-[80px] md:h-[100px] md:w-[100px] rounded-full object-cover bg-gray-300" />
                </div>
                <div className="pl-4 md:pl-8 flex flex-col justify-center">
