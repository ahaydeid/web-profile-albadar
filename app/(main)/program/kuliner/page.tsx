...
import { CheckCircle2, Briefcase, GraduationCap, ArrowRight, UtensilsCrossed } from "lucide-react";
import Link from "next/link";

export default function KulinerPage() {
  const kompetensi = [
    "Pengolahan makanan Indonesia, Asia, & Barat",
    "Teknik Pastry & Bakery (roti, kue, dessert)",
    "Tata Hidang & Penyajian Makanan",
    "Gizi & Sanitasi Makanan",
    "Dekorasi & Garnishing",
    "Manajemen Usaha Kuliner & Catering",
  ];

  const prospek = [
    "Chef di Hotel & Restoran",
    "Tenaga Pastry & Bakery",
    "Barista & Beverage Specialist",
    "Staf Catering & Tata Hidang",
    "Entrepreneur di bidang Kuliner",
    "Studi lanjut di bidang Perhotelan & Gizi",
  ];
      ...
      <section className="relative bg-[#3B2F63] text-white py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight">
            Kuliner <span className="text-yellow-400">(Tata Boga)</span>
          </h1>
          <p className="text-lg md:text-xl text-purple-100 max-w-3xl mx-auto leading-relaxed font-medium">
             Seni mengolah rasa dengan teknik profesional untuk mencetak chef dan entrepreneur kuliner yang berdaya saing global.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto py-24 px-6 md:px-10 space-y-32">
        ...
        <section className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#3B2F63] mb-8 leading-tight">
              Kreativitas Tanpa Batas di Dunia Kuliner
            </h2>
            <p className="text-slate-600 leading-relaxed text-lg font-medium mb-8">
              Kompetensi Keahlian <span className="text-[#3B2F63] font-bold">Kuliner (Tata Boga)</span> mempersiapkan peserta didik agar memiliki pengetahuan, keterampilan, dan sikap dalam mengolah makanan, mengelola usaha kuliner, serta memahami standar kebersihan dan keamanan pangan sesuai standar industri perhotelan.
            </p>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-sm flex items-start gap-4">
               <UtensilsCrossed className="text-yellow-500 shrink-0 mt-1" size={24} />
               <p className="text-slate-500 italic">&quot;Memadukan resep tradisional dengan teknik modern untuk menciptakan hidangan yang memiliki nilai seni dan ekonomi tinggi.&quot;</p>
            </div>
          </div>
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#3B2F63]">Seni & Keahlian</h2>
          </div>
        ...
        <section className="bg-slate-50 rounded-[60px] p-12 md:p-20 shadow-inner">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#3B2F63]">Masa Depan Cerah</h2>
          </div>
          ...
          <div className="mt-16 text-center">
             <div className="inline-flex items-center gap-4 bg-white/80 backdrop-blur px-8 py-4 rounded-full shadow-sm border border-slate-200">
               ...
               <p className="text-slate-600 font-medium">Bisa Melanjutkan ke Jurusan Perhotelan / Pariwisata / Gizi</p>
             </div>
          </div>
        </section>
        ...
        <section className="text-center">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#3B2F63] to-[#5b4a92] rounded-[50px] p-12 md:p-20 text-white shadow-2xl relative overflow-hidden">
            ...
            <h3 className="text-3xl md:text-4xl font-extrabold mb-8 relative z-10">
               Wujudkan Mimpimu Menjadi Chef Profesional!
            </h3>
            <p className="text-purple-100 mb-10 text-lg font-medium relative z-10 opacity-90">
               Jadilah bagian dari generasi kuliner masa depan bersama SMK Al-Badar Dangdeur dengan kurikulum berbasis industri dan praktek yang intensif.
            </p>
