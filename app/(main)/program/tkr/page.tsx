...
import { CheckCircle2, Briefcase, GraduationCap, ArrowRight, Settings } from "lucide-react";
      ...
      <section className="relative bg-[#3B2F63] text-white py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-purple-100 max-w-3xl mx-auto leading-relaxed font-medium">
            Mencetak ahli otomotif handal dengan penguasaan teknologi mesin modern dan sistem mekanikal kendaraan roda empat.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto py-24 px-6 md:px-10 space-y-32">
        ...
        <section className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#3B2F63] mb-8 leading-tight">
              Kuasai Teknologi Otomotif Masa Depan
            </h2>
            <p className="text-slate-600 leading-relaxed text-lg font-medium mb-8">
              Kompetensi Keahlian <span className="text-[#3B2F63] font-bold">Teknik Kendaraan Ringan (TKR)</span> menyiapkan siswa agar mampu melakukan diagnosa, perawatan, dan perbaikan sistem otomotif seperti mesin, sasis, kelistrikan, serta menguasai perkembangan teknologi kendaraan modern.
            </p>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-sm flex items-start gap-4">
               <Settings className="text-yellow-500 shrink-0 mt-1" size={24} />
               <p className="text-slate-500 italic">&quot;Kurikulum yang disinkronisasikan dengan kebutuhan industri otomotif terkini untuk menjamin keterserapan lulusan.&quot;</p>
            </div>
          </div>
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#3B2F63]">Kurikulum Keahlian</h2>
          </div>
        ...
        <section className="bg-slate-50 rounded-[60px] p-12 md:p-20 shadow-inner">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#3B2F63]">Peluang Kerja</h2>
          </div>
          ...
          <div className="mt-16 text-center">
             <div className="inline-flex items-center gap-4 bg-white/80 backdrop-blur px-8 py-4 rounded-full shadow-sm border border-slate-200">
               ...
               <p className="text-slate-600 font-medium">Melanjutkan ke Teknik Mesin / Otomotif di Perguruan Tinggi</p>
             </div>
          </div>
        </section>
        ...
        <section className="text-center">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#3B2F63] to-[#5b4a92] rounded-[50px] p-12 md:p-20 text-white shadow-2xl relative overflow-hidden">
            ...
            <h3 className="text-3xl md:text-4xl font-extrabold mb-8 relative z-10">
              Jadilah Ahli Otomotif Berkelas Dunia!
            </h3>
            <p className="text-purple-100 mb-10 text-lg font-medium relative z-10 opacity-90">
              Bergabunglah bersama SMK Al-Badar Dangdeur dan kuasai teknologi otomotif kendaraan ringan dengan fasilitas bengkel standar industri.
            </p>
