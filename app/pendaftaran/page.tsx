    ...
    <main className="bg-gray-50 text-gray-900">
      <section className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="text-center mb-10">
          <h2 className="text-sm font-semibold text-pink-600 uppercase tracking-wide">SMK Al Badar Tangerang</h2>
          <h1 className="text-3xl md:text-4xl font-bold">Prosedur Pendaftaran Siswa Baru</h1>
        </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 md:p-10">
          ...
          <p className="mb-6 leading-relaxed">
            SMK Al Badar Tangerang membuka pendaftaran siswa baru untuk tahun ajaran 2025-2026. Pendaftaran dibuka mulai tanggal <strong>20 Oktober 2025</strong> dan akan ditutup jika kuota terpenuhi.
          </p>
          ...
          <p className="mb-6">Seleksi akan dilaksanakan setiap hari Sabtu pukul 08.00 WIB di ruang ujian SMK Al Badar Tangerang.</p>

          {/* Pengumuman */}
          <h3 className="font-semibold mb-2">D. Pengumuman</h3>
          <p className="mb-6">Hasil seleksi akan diumumkan melalui WhatsApp atau papan pengumuman sekolah maksimal 3 hari setelah tes.</p>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 md:p-10 mt-10">
          ...
          <ol className="list-decimal list-inside space-y-1">
            <li>Fotokopi Ijazah SMP Sederajat (2 lembar)</li>
            <li>Fotokopi Kartu Keluarga (2 lembar)</li>
            <li>Fotokopi KTP Orang Tua/Wali (2 lembar)</li>
            <li>Fotokopi Akta Kelahiran (2 lembar)</li>
            <li>Fotokopi Surat Keterangan Lulus (jika ijazah belum keluar, 1 lembar)</li>
            <li>Fotokopi Kartu Indonesia Pintar (jika ada)</li>
            <li>Fotokopi Surat Keterangan Kematian dari Desa (bagi yatim) 1 lembar </li>
          </ol>
        </div>
