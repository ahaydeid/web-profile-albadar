    ...
    <section className="min-h-screen bg-[#faf9ff] py-16 px-4 md:px-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          <h1 className="text-3xl md:text-4xl font-bold text-center text-purple-700 mb-4">Struktur Organisasi SMKS Al Badar</h1>
          <div className="w-20 h-[3px] bg-purple-500 mx-auto mb-10 rounded-full"></div>
